...
const updateAnalyticsDisplay = (data) => {
  ...
  const recentQueriesElement = document.querySelector('#recent-queries');
  const topQueriesSectionElement = document.querySelector('#top-queries-section');
  const recentQueriesSectionElement = document.querySelector('#recent-queries-section');
